        ...
        <form action="mail.php" method="post" name="google-sheet" novalidate="" id="contactForm">
            ...
            <div class="row">
                <div class="col-lg-12">
                    ...
                    <input id="form_email" name="email" pattern="[A-Za-z0-9._%+-]+@[A-Za-z0-9.-]+\.[A-Za-z]{1,63}$"
                ...
                <div class="col-sm-12">
                    <div class="g-recaptcha" data-theme="light"
                        style="margin-left: 18%;transform:scale(0.77);-webkit-transform:scale(0.77);transform-origin:0 0;-webkit-transform-origin:0 0;"
                        data-sitekey="6LeGMnokAAAAAOM4bmA6v5Rm70gX5eJJqzvTSzQW"></div>
